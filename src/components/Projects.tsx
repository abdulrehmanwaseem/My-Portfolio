...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A mobile app for scheduling healthcare appointments and managing medical records.",
    technologies: ["React Native", "Node.js", "MongoDB", "Socket.io"],
    githubUrl: "https://github.com/abdulrehmanwaseem/healthcare-app",
    imageUrl: "https://images.pexels.com/photos/5952651/pexels-photo-5952651.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: 5,
    title: "Real-time Chat Application",
    description: "End-to-end encrypted messaging application with group chat functionality.",
    technologies: ["Socket.io", "React", "Express", "MongoDB", "WebRTC"],
    githubUrl: "https://github.com/abdulrehmanwaseem/chat-application",
    demoUrl: "#",
    imageUrl: "https://images.pexels.com/photos/2882553/pexels-photo-2882553.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: 6,
    title: "Code Collaboration Platform",
    description: "A platform for developers to collaborate on code in real-time with integrated version control.",
